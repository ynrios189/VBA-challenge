...
For Each ws In Worksheets
    ws.Select
     Call ModerateSolution
     Call ModerateSolution2016
     Call ModerateSolution2015
...
Sub ModerateSolution()
    ...
    ActiveWorkbook.Worksheets("2014").Sort.SortFields.Clear
    ActiveWorkbook.Worksheets("2014").Sort.SortFields.Add2 Key:=Range("A2:A705714"), _
        SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
    ActiveWorkbook.Worksheets("2014").Sort.SortFields.Add2 Key:=Range("B2:B705714"), _
        SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
    With ActiveWorkbook.Worksheets("2014").Sort
